    ...
    <a-form layout="inline">
      <a-form-item label="选择时间">
        <a-select v-model="seltime" :style="{width:'120px'}">
          <a-select-option :value="1">最近一个月</a-select-option>
          <a-select-option :value="3">最近三个月</a-select-option>
          <a-select-option :value="6">最近六个月</a-select-option>
        </a-select>
      </a-form-item>
      <a-form-item>
      ...
      axios
        .get(
          this.root_path.rootIP +
            ...
            "/eq/stat-customer/comStatByMonth",
          { params }
        )
        .then(res => {

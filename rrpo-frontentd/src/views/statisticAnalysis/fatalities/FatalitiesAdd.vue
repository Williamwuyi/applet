...
<!--              <a-select-option v-for="(n,index) in natureData" :key="index" :value="n.dictId">-->
<!--                {{n.fieldName}}-->
<!--              </a-select-option>-->
...
<!--              <a-select-option value="0.14">0.14</a-select-option>-->
<!--              <a-select-option value="0.13">0.13</a-select-option>-->
<!--              <a-select-option value="0.12">0.12</a-select-option>-->
<!--              <a-select-option value="0.11">0.11</a-select-option>-->
            </a-select>
          </a-form-item>
        </a-col>
        <a-col span="12">
  ...
  methods: {
    ...
    onInterface () {
      ...
      this.$post('/accident/accident/func', param).then(res => {
        ...
        //   dntjxs = 0.05
        // } else if (value === 'B') {
        //   // this.gaxsData = [{id: 0.15}, {id: 0.14}, {id: 0.13}, {id: 0.12}, {id: 0.11}, {id: 0.10}]
        //   dntjxs = 0.15
        // } else if (value === 'C') {
        //   dntjxs = 0.25
        // } else if (value === 'D') {
    ...
    handleSubmit () {
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          values.dnxs = this.dnxs
          values.dntjxs = this.dntjxs
          values.gaxs = this.gaxsDefaultValue
          values.deathToll = this.deathToll

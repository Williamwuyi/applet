...
import com.jiebao.platfrom.system.dao.MenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public Map<String, Object> findMenus(Menu menu) {
        ...
        try {
            ...
            result.put("ids", ids);
            if (StringUtils.equals(menu.getType(), JiebaoConstant.TYPE_BUTTON)) {
    ...
    @Override
    public List<Menu> findChilderMenu(String id) {

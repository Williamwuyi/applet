<template>
    ...
    <a-button class="btn" @click="handleAdd" type="primary" v-has-any-permission="'Fatalities:add'">
      添加
    </a-button>
    <a-button class="btn" @click="handleDel" style="background-color: #FF4040;color: white" v-has-any-permission="'Fatalities:delete'">
      删除
    </a-button>
      <a-button class="btn" @click="handleLock" style="background-color: #CDAD00;color: white" v-has-any-permission="'Fatalities:lock'">
        锁定
      </a-button>
      <a-button class="btn" @click="handleRelieve" style="background-color: #CD853F;color: white" v-has-any-permission="'Fatalities:lock'">
        解锁
       </a-button>
...
export default {
  ...
  methods: {
    ...
    cityQChange (key) {
      ...
      this.cityQsId = key
      this.character.cityLevelId = key
      this.unitX = ''
    },
    cityXChange (key) {
      this.cityXsId = key
      this.character.quDeptId = key
    },
    // 条件查询
    search () {
    ...
    onStartChange (value, date) {
      ...
      this.character.startDate = this.startTime
      this.restTime = null // 结束时间
    },
    // 选择结束时间
    onEndChange (value, date) {
      ...
      this.character.endDate = this.endTime

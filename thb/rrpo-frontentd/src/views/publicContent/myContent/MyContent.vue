<template>
  <a-card :bordered="false" class="card-area">
    ...
    <div>
      ...
      <a-button class="editable-add-btn" @click="handleDelete" v-hasPermission="'notice:delete'">
        删除
      </a-button>
      <a-upload
        name="file"
        ...
        @change="handleChange"
      ><a-button> <a-icon type="upload" /> 上传 </a-button></a-upload>
      <!--面包屑-->
      ...
      >
        ...
        <template slot="operation" slot-scope="text, record">
          <a-icon  type="setting" v-if="record.cms !== 0" theme="twoTone"  twoToneColor="#4a9ff5" style="margin-right: 5px"  @click="edit(record)" v-hasPermission="'notice:edit'" title="修改"></a-icon>
          <a-icon type="vertical-align-bottom" @click="download(record)" style="color: #4a9ff5" title="下载"/>
        </template>
      </a-table>
    </div>
    <!-- 新建 -->

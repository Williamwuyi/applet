        ...
        <ul class="lookOpinion clearboth">
          ...
          <li>
            ...
            <div v-if="money.quxian !== ''">
              <p class="content">{{auditOpinion.quxianaud}}</p>
              <span class="money" v-if="ranks == 1 || ranks == 4 || ranks == 0 || userParRank == 1">建议奖励金额<u>{{money.quxian}}</u>元</span>
...
export default {
  ...
  methods: {
    ...
    setFormValues (user) {
      this.lookList = user
      this.fieldName = user.identityObject.fieldName

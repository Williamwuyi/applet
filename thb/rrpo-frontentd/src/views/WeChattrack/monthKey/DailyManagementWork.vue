<template>
  <div style="width: 100%; min-height: 690px">
    ...
    <div>
      ...
      <a-button class="editable-add-btn"  @click="TimeClick">
        月评统计
      </a-button>
      <a-table
...
import monthModal from './DailymonthModal'
import {mapMutations} from 'vuex'
export default {
  name: 'Notice',
  components: {Dmlook, NoticeEdit, Noticeadd, DModal, BModal, DailyTime, monthModal},
  data () {
    return {
      character: {},
      data: [],

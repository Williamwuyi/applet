...
public class LogController extends BaseController {
    ...
    public void deleteLogss(@NotBlank(message = "{required}") @PathVariable String ids) throws JiebaoException {
        try {
    ...
    public void export(QueryRequest request, SysLog sysLog, HttpServletResponse response) throws JiebaoException {
        try {
